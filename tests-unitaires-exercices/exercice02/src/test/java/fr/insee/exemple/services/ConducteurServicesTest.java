...
public class ConducteurServicesTest {
	...
	public void filtrerConducteursPossedantAuMoinsUnModelePeuPolluantTest() {
		...
		final ModeleVoiture polluant = new ModeleVoiture("Citroen", "Saxo", Carburant.ESSENCE,
				LocalDate.of(1995, 01, 01));
		final ModeleVoiture peuPolluant = new ModeleVoiture("Citroen", "Saxo", Carburant.ELECTRIQUE,
		...
		List<Conducteur> conducteurs = Arrays.asList(conducteurAvecUnSeulVehiculePolluant,
				conducteurAvecUnSeulVehiculePeuPolluant, conducteurAvecUnVehiculePolluantEtUnPeuPolluant);
		...
		assertThat(conducteursAvecAuMoinsUneVoiturePeuPolluante).containsExactlyInAnyOrder(
				conducteurAvecUnSeulVehiculePeuPolluant, conducteurAvecUnVehiculePolluantEtUnPeuPolluant);
